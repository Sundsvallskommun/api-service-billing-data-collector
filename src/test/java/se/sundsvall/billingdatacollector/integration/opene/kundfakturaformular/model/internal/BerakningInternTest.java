...
class BerakningInternTest {

	@Test
	void testBean() {
		assertThat(BerakningIntern.class, allOf(
	...
	void testBuilderMethods() {
		...
		final var berakningarIntern = BerakningIntern.builder()
			.withQueryID(queryID)
			.withName(name)
	...
	void testNoDirtOnCreatedBean() {
		assertThat(BerakningIntern.builder().build()).isNotNull().hasAllNullFieldsOrProperties();
	}
}
