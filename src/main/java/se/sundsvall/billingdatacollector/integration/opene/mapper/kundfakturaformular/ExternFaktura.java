...
record ExternFaktura(
	...
	@XPath("/FlowInstance/Values/BarakningarExtern1/FakturatextExtern1") String fakturaText,

	@XPath("/FlowInstance/Values/BarakningarExtern1/AntalExtern1") Integer antal,

	@XPath("/FlowInstance/Values/BarakningarExtern1/APrisExtern1") String aPris,

	@XPath("/FlowInstance/Values/SummeringExtern1/TotSummeringExtern1") String summeringExtern,

	@XPath("/FlowInstance/Values/MomssatsExtern1/Value") String momssats,

	@XPath("/FlowInstance/Values/AnsvarExtern1/Value") String ansvar,

	@XPath("/FlowInstance/Values/UnderkontoExtern1/Value") String underkonto,

	@XPath("/FlowInstance/Values/VerksamhetExtern1/Value") String verksamhet,

	@XPath("/FlowInstance/Values/AktivitetskontoExtern1/Value") String aktivitetskonto,

	@XPath("/FlowInstance/Values/ObjektkontoExtern1/Value") String objektkonto) {}
