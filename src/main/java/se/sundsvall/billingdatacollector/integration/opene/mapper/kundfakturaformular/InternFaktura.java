...
record InternFaktura(
	...
	@XPath("/FlowInstance/Values/BerakningIntern1/AntalIntern1") Integer antal,

	@XPath("/FlowInstance/Values/BerakningIntern1/APrisIntern1") String aPris,

	@XPath("/FlowInstance/Values/SummeringIntern1/TotSummeringIntern1") String summeringIntern,

	@XPath("/FlowInstance/Values/AnsvarIntern1/Value") String ansvar,

	@XPath("/FlowInstance/Values/UnderkontoIntern1/Value") String underkonto,

	@XPath("/FlowInstance/Values/VerksamhetIntern1/Value") String verksamhet,

	@XPath("/FlowInstance/Values/AktivitetskontoIntern1/Value") String aktivitetskonto) {}
