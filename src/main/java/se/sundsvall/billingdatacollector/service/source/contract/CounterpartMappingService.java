...
public class CounterpartMappingService {
	...
	public CounterpartMappingService(CounterpartMappingRepository repository) {
	 ...
	 *
	 * @param  legalId                              the legal ID to match
	 ...
	 */
	public String findCounterpartByLegalId(String legalId, String stakeholderType) {
		LOG.debug("Finding counterpart for legalId: {}, stakeholderType: {}", legalId, stakeholderType);
		...
		LOG.warn("No counterpart found for legalId: {}, stakeholderType: {}", legalId, stakeholderType);
		throw Problem.builder()
			.withStatus(NOT_FOUND)
			.withDetail("No counterpart found for legalId: " + legalId + " or stakeholderType: " + stakeholderType)
			.build();
	}
